...
Calculator_testRsp_args::~Calculator_testRsp_args() throw() {
}


uint32_t Calculator_testRsp_args::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Calculator_testRsp_args::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Calculator_testRsp_args");
...
Calculator_testRsp_pargs::~Calculator_testRsp_pargs() throw() {
}


uint32_t Calculator_testRsp_pargs::write(::apache::thrift::protocol::TProtocol* oprot) const {
  uint32_t xfer = 0;
  ::apache::thrift::protocol::TOutputRecursionTracker tracker(*oprot);
  xfer += oprot->writeStructBegin("Calculator_testRsp_pargs");
...
Calculator_testRsp_result::~Calculator_testRsp_result() throw() {
}


uint32_t Calculator_testRsp_result::read(::apache::thrift::protocol::TProtocol* iprot) {
...
uint32_t Calculator_testRsp_result::write(::apache::thrift::protocol::TProtocol* oprot) const {

  uint32_t xfer = 0;

  xfer += oprot->writeStructBegin("Calculator_testRsp_result");
...
Calculator_testRsp_presult::~Calculator_testRsp_presult() throw() {
}


uint32_t Calculator_testRsp_presult::read(::apache::thrift::protocol::TProtocol* iprot) {
...
void CalculatorClient::testRsp(TestSetMap& _return, const Work& w)
{
  send_testRsp(w);
  recv_testRsp(_return);
}

void CalculatorClient::send_testRsp(const Work& w)
{
  int32_t cseqid = 0;
  oprot_->writeMessageBegin("testRsp", ::apache::thrift::protocol::T_CALL, cseqid);

  Calculator_testRsp_pargs args;
  args.w = &w;
  args.write(oprot_);
...
void CalculatorClient::recv_testRsp(TestSetMap& _return)
{
  ...
  if (fname.compare("testRsp") != 0) {
    iprot_->skip(::apache::thrift::protocol::T_STRUCT);
    iprot_->readMessageEnd();
    iprot_->getTransport()->readEnd();
  }
  Calculator_testRsp_presult result;
  result.success = &_return;
  result.read(iprot_);
  iprot_->readMessageEnd();
  iprot_->getTransport()->readEnd();
  ...
  throw ::apache::thrift::TApplicationException(::apache::thrift::TApplicationException::MISSING_RESULT, "testRsp failed: unknown result");
}
...
void CalculatorProcessor::process_testRsp(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  void* ctx = NULL;
  if (this->eventHandler_.get() != NULL) {
    ctx = this->eventHandler_->getContext("Calculator.testRsp", callContext);
  }
  ::apache::thrift::TProcessorContextFreer freer(this->eventHandler_.get(), ctx, "Calculator.testRsp");

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preRead(ctx, "Calculator.testRsp");
  }

  Calculator_testRsp_args args;
  args.read(iprot);
  iprot->readMessageEnd();
  uint32_t bytes = iprot->getTransport()->readEnd();

  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postRead(ctx, "Calculator.testRsp", bytes);
  }

  Calculator_testRsp_result result;
  try {
    iface_->testRsp(result.success, args.w);
    result.__isset.success = true;
  } catch (const std::exception& e) {
    if (this->eventHandler_.get() != NULL) {
      this->eventHandler_->handlerError(ctx, "Calculator.testRsp");
    }

    ::apache::thrift::TApplicationException x(e.what());
    oprot->writeMessageBegin("testRsp", ::apache::thrift::protocol::T_EXCEPTION, seqid);
    x.write(oprot);
    oprot->writeMessageEnd();
    oprot->getTransport()->writeEnd();
    oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->preWrite(ctx, "Calculator.testRsp");
  }

  oprot->writeMessageBegin("testRsp", ::apache::thrift::protocol::T_REPLY, seqid);
  result.write(oprot);
  oprot->writeMessageEnd();
  bytes = oprot->getTransport()->writeEnd();
  oprot->getTransport()->flush();
  ...
  if (this->eventHandler_.get() != NULL) {
    this->eventHandler_->postWrite(ctx, "Calculator.testRsp", bytes);
  }
}
...
void CalculatorConcurrentClient::testRsp(TestSetMap& _return, const Work& w)
{
  int32_t seqid = send_testRsp(w);
  recv_testRsp(_return, seqid);
}

int32_t CalculatorConcurrentClient::send_testRsp(const Work& w)
{
  int32_t cseqid = this->sync_.generateSeqId();
  ::apache::thrift::async::TConcurrentSendSentry sentry(&this->sync_);
  oprot_->writeMessageBegin("testRsp", ::apache::thrift::protocol::T_CALL, cseqid);
...
void CalculatorConcurrentClient::recv_testRsp(TestSetMap& _return, const int32_t seqid)
{
